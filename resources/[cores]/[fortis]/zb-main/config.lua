...
QBConfig.Server.closedReason = "🔸 Er is op dit moment onderhoud gaande... Join de Discord voor meer informatie: ".. GetConvar('Discord', 'https://discord.gg/fxuqDutUK5')  -- Reason message to display when people can't join the server
QBConfig.Server.uptime = 0 -- Time the server has been up.
QBConfig.Server.whitelist = false -- Enable or disable whitelist on the server
QBConfig.Server.discord = GetConvar('Discord', 'https://discord.gg/fxuqDutUK5') -- Discord invite link
